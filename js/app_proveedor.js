$(document).ready(function(){
    $('#btnConsultarProveedores').click(function(event) {
        ...
        $("#enviarProveedor").click(function(e) {
            e.preventDefault();
            
            var id_proveedor = $("#id_proveedor").val();
            var nombreProv = $("#nombreProv").val();
            var telefono = $("#direccionProv").val();
            var direccionProv = $("#direccionProv").val();
            var medio_pago = $("")
            ...
            $.ajax({
                url: "http://localhost:8080/addproveedor",
                type: "POST",
